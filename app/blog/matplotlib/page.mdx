...
个人学习matplotlib的感觉，其实整体代码没有很多复杂性就是用文字的形式设置一些图形的属性，比如坐标轴标签，图例，坐标轴范围等等，matplotlib的文档也是非常全面的，如果有不懂的地方，可以查看文档，或者上网搜索，基本上都能找到答案。
再结合一点 python 基础就可以非常便捷的画出我们想要的各种图了。
