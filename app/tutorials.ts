...
export const TUTORIAL_PHASES: Array<{
  ...
  },
  {
    ...
    topics: [
      ...
      {
        slug: '02_04-constant-potential-principles',
        title: '2.4 恒电势计算原理',
  ...
  {
    title: 'Phase 3 · 机器学习与 AI4S',
    description: '从经典机器学习过渡到可解释模型、深度学习和 AI4S 专题。',
    topics: [
      {
        slug: '03_01-classical-ml',
        title: '3.1 传统机器学习',
        summary: '面向回归、分类、特征工程、交叉验证与误差分析。',
        phase: 'Phase 3 · 机器学习与 AI4S',
      },
      {
        slug: '03_02-interpretable-ml',
        title: '3.2 可解释机器学习',
        summary: '围绕 SISSO、特征重要性与描述符构建思路。',
        phase: 'Phase 3 · 机器学习与 AI4S',
      },
      {
        slug: '03_03-deep-learning',
        title: '3.3 深度学习',
        summary: '以 PyTorch 为主线，覆盖训练循环、调参与 GPU 基础。',
        phase: 'Phase 3 · 机器学习与 AI4S',
      },
      {
        slug: '03_04-ai4s-modeling',
        title: '3.4 AI4S 建模专题',
  ...
  },
  {
    ...
    topics: [
      {
        slug: '04_01-research-engineering',
        title: '4.1 科研工程化实践',
        summary: '聚焦批量 workflow、输入生成、结果提取和异常检测。',
        phase: 'Phase 4 · 项目实战',
      },
      {
        slug: '04_02-paper-to-reproduction',
        title: '4.2 从论文到复现',
        summary: '整理如何读论文、拆流程、做复现笔记和搭脚手架。',
        phase: 'Phase 4 · 项目实战',
      },
      {
        slug: '04_03-research-to-model',
        title: '4.3 从科研问题到模型问题',
